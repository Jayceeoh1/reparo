...
const SERVICE_CATEGORIES = [
  { cat:'ðŸ”§ Revizie & MentenanÈ›Äƒ', items:['Schimb ulei motor','Schimb filtre (aer, polen, combustibil)','Verificare generalÄƒ','Schimb lichid frÃ¢nÄƒ','Schimb lichid rÄƒcire (antigel)','Schimb lichid servo','Schimb bujii / bujii incandescente'] },
  { cat:'ðŸ›‘ FrÃ¢ne', items:['Schimb plÄƒcuÈ›e frÃ¢nÄƒ','Schimb discuri frÃ¢nÄƒ','Schimb etrieri','RecondiÈ›ionare etrieri','Aerisire sistem frÃ¢nare','DiagnozÄƒ sistem frÃ¢nare'] },
  { cat:'âš™ï¸ MecanicÄƒ generalÄƒ', items:['Suspensie (amortizoare, arcuri)','DirecÈ›ie (bielete, capete barÄƒ)','Planetare','RulmenÈ›i roatÄƒ','Sistem evacuare','ReparaÈ›ii motor generale','ReparaÈ›ii cutie viteze','Revizie cutie viteze'] },
  { cat:'ðŸ”¥ DistribuÈ›ie & Motor', items:['Schimb kit distribuÈ›ie','Schimb curea accesorii','ReparaÈ›ii motor','GarniturÄƒ chiulasÄƒ','Rectificare motor'] },
  { cat:'âš¡ ElectricÄƒ auto', items:['DiagnozÄƒ electricÄƒ','ReparaÈ›ii instalaÈ›ie electricÄƒ','Alternator','Electromotor','Senzori','Probleme bord / martori'] },
  { cat:'ðŸ’» DiagnozÄƒ electronicÄƒ', items:['Scanare erori','Resetare erori','CodÄƒri / adaptÄƒri','ActualizÄƒri software'] },
  { cat:'â„ï¸ Climatizare & AC', items:['ÃŽncÄƒrcare freon','Verificare instalaÈ›ie AC','ReparaÈ›ii compresor','CurÄƒÈ›are instalaÈ›ie AC'] },
  { cat:'ðŸŽ¨ Vopsitorie & Caroserie', items:['Vopsitorie element','Vopsitorie integralÄƒ','Tinichigerie','ÃŽndreptare caroserie','Polish auto','ReparaÈ›ii daune'] },
  { cat:'ðŸ›ž Anvelope & RoÈ›i', items:['Montaj anvelope','Demontaj anvelope','Echilibrare roÈ›i','Geometrie roÈ›i','Vulcanizare'] },
  { cat:'ðŸš— ITP', items:['ITP autoturisme','ITP autoutilitare'] },
  { cat:'ðŸ”‹ Baterii & Electric Hibrid', items:['Schimb baterie','Test baterie','Sisteme hibride / electrice'] },
  { cat:'â›½ Sistem combustibil', items:['ReparaÈ›ii injectoare','CurÄƒÈ›are injectoare','ReparaÈ›ii pompÄƒ combustibil','ReparaÈ›ii sistem alimentare'] },
  { cat:'ðŸš˜ Transmisie', items:['Ambreiaj','VolantÄƒ','Cutie manualÄƒ','Cutie automatÄƒ','Schimb ulei cutie'] },
  { cat:'ðŸš¨ TractÄƒri & AsistenÈ›Äƒ', items:['Tractare auto','AsistenÈ›Äƒ rutierÄƒ','Pornire baterie','Transport auto'] },
  { cat:'ðŸ§¼ Detailing & EsteticÄƒ', items:['SpÄƒlare auto','Detailing interior','Detailing exterior','Polish','ProtecÈ›ie ceramicÄƒ','CurÄƒÈ›are tapiÈ›erie'] },
  { cat:'ðŸ›¡ï¸ Accesorii & ProtecÈ›ii', items:['Folii geamuri','PPF (protecÈ›ie vopsea)','Montaj accesorii'] },
  { cat:'ðŸ”‘ Chei & ÃŽnchideri', items:['Chei auto','Programare chei','ReparaÈ›ii Ã®nchideri'] },
  { cat:'ðŸ”¥ Tuning & Performance', items:['Remap ECU','Stage 1','Stage 2','Tuning motor'] },
]
const ALL_SERVICES = SERVICE_CATEGORIES.flatMap(c=>c.items)
const ALL_BRANDS = [
  'Alfa Romeo','Aston Martin','Audi','BMW','Bentley','Bugatti','Buick',
  'Cadillac','Chevrolet','Chrysler','CitroÃ«n','Cupra','Dacia','Daewoo',
...
const COUNTIES = ['Alba','Arad','ArgeÈ™','BacÄƒu','Bihor','BistriÈ›a-NÄƒsÄƒud','BotoÈ™ani','BrÄƒila','BraÈ™ov','BucureÈ™ti','BuzÄƒu','CÄƒlÄƒraÈ™i','CaraÈ™-Severin','Cluj','ConstanÈ›a','Covasna','DÃ¢mboviÈ›a','Dolj','GalaÈ›i','Giurgiu','Gorj','Harghita','Hunedoara','IalomiÈ›a','IaÈ™i','Ilfov','MaramureÈ™','MehedinÈ›i','MureÈ™','NeamÈ›','Olt','Prahova','SÄƒlaj','Satu Mare','Sibiu','Suceava','Teleorman','TimiÈ™','Tulcea','VÃ¢lcea','Vaslui','Vrancea']
const APT_STATUS = {in_asteptare:{label:'AÈ™teptare',bg:S.amberBg,color:S.amber},confirmata:{label:'ConfirmatÄƒ',bg:'#dbeafe',color:S.blue},in_lucru:{label:'ÃŽn lucru',bg:S.purpleBg,color:S.purple},finalizata:{label:'FinalizatÄƒ',bg:S.greenBg,color:S.green},anulata:{label:'AnulatÄƒ',bg:S.redBg,color:S.red}}


// â•â• MapPicker Component â€” Click pe hartÄƒ = adresÄƒ automatÄƒ â•â•
function MapPicker({ address, city, onAddressChange }) {
  ...
  function initMap() {
    ...
    // Initial coordinates â€” Bucharest default
  ...
  return (
    <div>
      ...
      <div style={{ display:'flex', gap:8, marginBottom:8, position:'relative' }}>
        <div style={{ flex:1, position:'relative' }}>
          <input value={search} onChange={e=>setSearch(e.target.value)}
            ...
            placeholder="CautÄƒ adresa sau dÄƒ click direct pe hartÄƒ..."
      ...
      <div style={{ fontSize:12, color:S2.muted, marginBottom:8, display:'flex', alignItems:'center', gap:4 }}>
        ðŸ‘† DÄƒ click pe hartÄƒ pentru a plasa pinul Â· Pinul se poate trage
        {loading&&<span style={{ marginLeft:8, color:S2.blue }}>Se detecteazÄƒ adresa...</span>}
      </div>
      ...
      <div style={{ display:'flex', alignItems:'center', gap:10, flexWrap:'wrap' }}>
        <button onClick={handleSave}
          ...
          {saved?'âœ… LocaÈ›ie confirmatÄƒ!':'ðŸ“ ConfirmÄƒ locaÈ›ia'}
        </button>
        {pinLat&&pinLon&&(
          <a href={`https://maps.google.com/maps?q=${pinLat},${pinLon}`} target="_blank" rel="noopener noreferrer"
            ...
            ðŸ—ºï¸ Deschide Ã®n Google Maps â†’
          </a>
        )}
        {search&&<div style={{ fontSize:12, color:S2.muted, background:S2.bg, borderRadius:8, padding:'6px 12px', flex:1 }}>ðŸ“ {search}</div>}
      </div>
    </div>
  )
}
...
export default function ServiceDashboard() {
  const [tab, setTab] = useState('AcasÄƒ')
  ...
  const [pf, setPf] = useState({name:'',description:'',phone:'',email:'',website:'',facebook_url:'',address:'',city:'',county:'',postal_code:'',brands_accepted:[],fuel_types:[],min_year_accepted:'',is_authorized_rar:false,has_itp:false,warranty_months:'0',is_multibrand:true,is_dismantling:false,opening_hours:{Lu:'08:00-18:00',Ma:'08:00-18:00',Mi:'08:00-18:00',Jo:'08:00-18:00',Vi:'08:00-18:00',SÃ¢:'09:00-14:00',Du:'ÃŽnchis'}})
  ...
  useEffect(() => {
    async function load() {
      ...
      // VerificÄƒ rolul â€” doar service_owner poate accesa dashboard-ul
      ...
      if (!svc) {
        // CreeazÄƒ service doar dacÄƒ userul are rol de service_owner
        const { data: newSvc } = await supabase.from('services').insert({owner_id:user.id,name:prof?.full_name||'Service-ul meu',city:prof?.city||'BucureÈ™ti',is_active:true,plan:'free'}).select().single()
        svc = newSvc
      }
      setService(svc)
      if (svc) {
  ...
  async function addWholeCategory(catItems) {
    ...
    if (toAdd.length===0) {
      alert('Toate serviciile din aceastÄƒ categorie sunt deja adÄƒugate.')
      return
    }
  ...
  const TABS = [
    {name:'AcasÄƒ',icon:'ðŸ ',badge:null},
    {name:'Profil public',icon:'ðŸª',badge:(!pf.description||!pf.phone||!pf.address)?'!':null},
    {name:'Servicii oferite',icon:'ðŸ”§',badge:offerings.length||null},
    {name:'Cereri',icon:'ðŸ“‹',badge:requests.length||null},
    {name:'ProgramÄƒri',icon:'ðŸ“…',badge:appointments.filter(a=>['in_asteptare','confirmata','in_lucru'].includes(aptStatuses[a.id]||a.status)).length||null},
    {name:'Oferte trimise',icon:'ðŸ’¬',badge:offers.filter(o=>o.status==='trimisa').length||null},
    {name:'AnunÈ›uri',icon:'ðŸ“¦',badge:null},
    {name:'Recenzii',icon:'â­',badge:reviews.length||null},
    {name:'SetÄƒri',icon:'âš™ï¸',badge:null},
  ]
    ...
    <div style={{minHeight:'100vh',background:S.bg,fontFamily:"'DM Sans',sans-serif",display:'flex',flexDirection:'column'}}>
      {loading&&(
        <div style={{position:'fixed',inset:0,background:S.bg,display:'flex',alignItems:'center',justifyContent:'center',zIndex:9999}}>
          <div style={{textAlign:'center'}}>
            ...
            <div style={{color:S.muted,fontSize:14}}>Se Ã®ncarcÄƒ...</div>
          </div>
        </div>
      )}
      <style>{`
      ...
      <div style={{background:'#0a1f44',height:56,display:'flex',alignItems:'center',padding:'0 24px',position:'sticky',top:0,zIndex:100,gap:12}}>
        ...
        <div style={{marginLeft:'auto',display:'flex',alignItems:'center',gap:12}}>
          {service?.id&&<a href={`/service/${service.id}`} target="_blank" style={{fontSize:12,color:'rgba(255,255,255,0.5)',textDecoration:'none'}}>ðŸ‘ï¸ Profil public</a>}
          <button onClick={async()=>{await supabase.auth.signOut();window.location.href='/home'}} style={{fontSize:12,color:'rgba(255,255,255,0.4)',background:'none',border:'none',cursor:'pointer',fontFamily:"'DM Sans',sans-serif"}}>IeÈ™i</button>
        </div>
      </div>
        ...
        <aside className={`dash-sidebar${mounted && sidebarOpen?' open':''}`}
          ...
          <div style={{padding:'20px 16px 16px',borderBottom:'1px solid rgba(255,255,255,0.08)'}}>
            ...
            <span style={{display:'inline-flex',alignItems:'center',padding:'3px 10px',borderRadius:50,background:'rgba(245,158,11,0.15)',border:'1px solid rgba(245,158,11,0.3)',fontSize:11,fontWeight:700,color:'#f59e0b',fontFamily:"'Sora',sans-serif"}}>
              {service?.plan==='pro'?'â­ Pro':'ðŸ”“ Free'}
            </span>
          </div>
          ...
          <div style={{padding:'10px',borderTop:'1px solid rgba(255,255,255,0.08)'}}>
            <a href="/home" style={{display:'flex',alignItems:'center',gap:8,padding:'10px 12px',borderRadius:10,color:'rgba(255,255,255,0.4)',textDecoration:'none',fontSize:13,fontFamily:"'DM Sans',sans-serif"}}>ðŸ  ÃŽnapoi la site</a>
          </div>
        </aside>
        ...
        <div className="dash-main" style={{overflowY:'auto',padding:'24px',minWidth:0,paddingBottom:'100px'}}>
            ...
            <div>
              ...
              <div style={{background:'linear-gradient(135deg,#1a56db 0%,#0a1f44 100%)',borderRadius:20,padding:'24px 28px',marginBottom:20,display:'flex',alignItems:'center',justifyContent:'space-between',position:'relative',overflow:'hidden'}}>
                ...
                <div>
                  ...
                  <h1 style={{fontFamily:"'Sora',sans-serif",fontWeight:800,fontSize:22,color:'#fff',marginBottom:6}}>BunÄƒ ziua, {service?.name}! ðŸ‘‹</h1>
                  <p style={{color:'rgba(255,255,255,0.55)',fontSize:13}}>
                    {requests.length > 0 ? `Ai ${requests.length} cereri noi care te aÈ™teaptÄƒ.` : 'Profilul tÄƒu este activ È™i vizibil Ã®n cÄƒutÄƒri.'}
                  </p>
                </div>
              ...
              {(!pf.description||!pf.phone||!pf.address)&&(
                <div style={{background:S.amberBg,border:`1px solid ${S.amber}40`,borderRadius:14,padding:16,marginBottom:20,display:'flex',alignItems:'center',gap:12}}>
                  ...
                  <div style={{flex:1}}>
                    <div style={{fontWeight:700,color:S.amber,fontSize:14,fontFamily:"'Sora',sans-serif",marginBottom:3}}>Profilul tÄƒu e incomplet</div>
                    <div style={{color:S.amber,fontSize:13,opacity:.8}}>AdaugÄƒ descriere, telefon È™i adresÄƒ pentru a apÄƒrea Ã®n cÄƒutÄƒri.</div>
                  </div>
                  <button onClick={()=>setTab('Profil public')} style={{...btn('primary'),background:S.amber,boxShadow:'none',flexShrink:0}}>CompleteazÄƒ â†’</button>
                </div>
              )}
              ...
              <div className="dash-stats" style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:12,marginBottom:20}}>
                {[
                  {label:'Cereri noi',value:requests.length,icon:'ðŸ“‹',accent:S.blue,accentBg:'#eaf3ff',tab:'Cereri'},
                  {label:'ProgramÄƒri azi',value:appointments.filter(a=>a.scheduled_date===today).length,icon:'ðŸ“…',accent:S.green,accentBg:S.greenBg,tab:'ProgramÄƒri'},
                  {label:'Oferte active',value:offers.filter(o=>o.status==='trimisa').length,icon:'ðŸ’¬',accent:S.purple,accentBg:S.purpleBg,tab:'Oferte trimise'},
                  {label:'Rating',value:service?.rating_avg>0?service.rating_avg.toFixed(1):null,icon:'â­',accent:S.amber,accentBg:S.amberBg,tab:'Recenzii'},
                ].map(s=>(
              ...
              <div style={card({marginBottom:16})}>
                <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:14}}>
                  <h2 style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:15,color:S.navy}}>Cereri noi Ã®n {service?.city}</h2>
                  <button onClick={()=>setTab('Cereri')} style={{...btn('ghost'),padding:'6px 12px',fontSize:12}}>Vezi toate â†’</button>
                </div>
                {requests.length===0?<div style={{textAlign:'center',padding:'20px 0',color:S.muted,fontSize:14}}>Nicio cerere activÄƒ momentan.</div>:
                  requests.slice(0,3).map(r=>(
                    <div key={r.id} style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'12px',background:S.bg,borderRadius:12,marginBottom:8}}>
                      <div>
                        <div style={{fontWeight:600,fontSize:14,color:S.navy,marginBottom:2}}>{r.car_brand} {r.car_model} {r.car_year?`Â· ${r.car_year}`:''}</div>
                        <div style={{fontSize:12,color:S.muted}}>{r.services?.join(', ')}</div>
                      </div>
                      <button onClick={()=>{setSelectedReq(r);setTab('Cereri')}} style={{...btn('primary'),padding:'7px 14px',fontSize:12}}>Trimite ofertÄƒ</button>
                    </div>
                  ))
                }
              </div>
              ...
              <div style={card()}>
                <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:14}}>
                  <h2 style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:15,color:S.navy}}>ProgramÄƒri azi</h2>
                  <button onClick={()=>setTab('ProgramÄƒri')} style={{...btn('ghost'),padding:'6px 12px',fontSize:12}}>Calendar â†’</button>
                </div>
                {appointments.filter(a=>a.scheduled_date===today).length===0?<div style={{textAlign:'center',padding:'20px 0',color:S.muted,fontSize:14}}>Nicio programare astÄƒzi.</div>:
            ...
            <div>
              <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:20,flexWrap:'wrap',gap:12}}>
                <div>
                  ...
                  <p style={{color:S.muted,fontSize:13}}>Aceste informaÈ›ii apar pe pagina ta publicÄƒ È™i Ã®n cÄƒutÄƒri.</p>
                </div>
                <div style={{display:'flex',gap:8}}>
                  {service?.id&&<a href={`/service/${service.id}`} target="_blank" style={{...btn('ghost'),textDecoration:'none',fontSize:12}}>ðŸ‘ï¸ PrevizualizeazÄƒ</a>}
                  <button onClick={saveProfile} disabled={profileSaving}
                    style={{...btn('primary'),background:profileSaved?S.green:S.blue,opacity:profileSaving?.6:1}}>
                    {profileSaved?'âœ… Salvat!':profileSaving?'Se salveazÄƒ...':'SalveazÄƒ profilul'}
                  </button>
                </div>
              </div>
              ...
              <div style={{...card({marginBottom:16,gridColumn:'1/-1'})}}>
                <h3 style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:14,color:S.navy,marginBottom:16}}>ðŸ“¸ Fotografii profil</h3>
                <div style={{display:'grid',gridTemplateColumns:'120px 1fr',gap:16,alignItems:'start'}}>
                  <div>
                    ...
                    <div onClick={()=>document.getElementById('logo-upload').click()}
                      ...
                      {service?.logo_url?<img src={service.logo_url} alt="" style={{width:'100%',height:'100%',objectFit:'cover'}}/>:<div style={{textAlign:'center',color:S.muted}}><div style={{fontSize:32,marginBottom:4}}>ðŸ”§</div><div style={{fontSize:10}}>Click pentru logo</div></div>}
                    </div>
                  ...
                  <div>
                    ...
                    <div onClick={()=>document.getElementById('cover-upload').click()}
                      ...
                      {service?.cover_image_url?<img src={service.cover_image_url} alt="" style={{width:'100%',height:'100%',objectFit:'cover'}}/>:<div style={{textAlign:'center',color:S.muted}}><div style={{fontSize:28,marginBottom:4}}>ðŸ–¼ï¸</div><div style={{fontSize:11}}>Click pentru banner</div><div style={{fontSize:10,marginTop:2}}>Recomandat: 1200Ã—400px</div></div>}
                    </div>
              ...
              <div className="profile-grid" style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:16}}>
                {/* Informatii baza */}
                <div style={card()}>
                  <h3 style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:14,color:S.navy,marginBottom:16}}>ðŸ“‹ InformaÈ›ii de bazÄƒ</h3>
                  {[{k:'name',l:'Numele service-ului *',p:'AutoPro Service SRL',t:'text'},{k:'phone',l:'Telefon *',p:'07xx xxx xxx',t:'tel'},{k:'email',l:'Email contact',p:'contact@service.ro',t:'email'},{k:'website',l:'Website',p:'https://...',t:'url'},{k:'facebook_url',l:'PaginÄƒ Facebook',p:'https://facebook.com/...',t:'url'}].map(f=>(
                  ...
                  <div style={{marginBottom:12}}>
                    ...
                    <textarea className="dash-input" value={pf.description} onChange={e=>setPf(p=>({...p,description:e.target.value}))} rows={4} placeholder="Descrie service-ul tÄƒu: specializÄƒri, echipamente, experienÈ›Äƒ..."
                ...
                {/* Locatie */}
                <div style={card()}>
                  <h3 style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:14,color:S.navy,marginBottom:16}}>ðŸ“ LocaÈ›ie</h3>
                  <div style={{marginBottom:12}}>
                    <label style={label}>Adresa completÄƒ *</label>
                  ...
                  <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10,marginBottom:12}}>
                    <div>
                      <label style={label}>OraÈ™ *</label>
                      <input className="dash-input" value={pf.city} onChange={e=>setPf(p=>({...p,city:e.target.value}))} placeholder="BucureÈ™ti" style={input}/>
                    </div>
                    <div>
                      <label style={label}>JudeÈ›</label>
                  ...
                  {/* HartÄƒ interactivÄƒ cu search */}
                  <div>
                    <label style={label}>HartÄƒ & locaÈ›ie</label>
                    <MapPicker
                      address={pf.address}
                      city={pf.city}
                  ...
                  <h3 style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:14,color:S.navy,margin:'20px 0 12px'}}>ðŸ• Program lucru</h3>
                  {Object.entries(pf.opening_hours).map(([day,hours])=>(
                    <div key={day} style={{display:'flex',alignItems:'center',gap:10,marginBottom:8}}>
                      ...
                      <input className="dash-input" value={hours} onChange={e=>setPf(p=>({...p,opening_hours:{...p.opening_hours,[day]:e.target.value}}))} placeholder="08:00-18:00 sau ÃŽnchis" style={{...input,padding:'8px 12px',fontSize:12}}/>
                    </div>
                  ))}
                </div>
                ...
                <div style={{...card(),gridColumn:'1/-1'}}>
                  <h3 style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:14,color:S.navy,marginBottom:16}}>ðŸš— SpecializÄƒri & certificÄƒri</h3>

                  {/* Tip service */}
                  <div style={{marginBottom:20}}>
                    <label style={label}>Tip service</label>
                    <div style={{display:'flex',gap:10,flexWrap:'wrap'}}>
                      {[{val:true,icon:'ðŸŒ',label:'MultimarcÄƒ',desc:'ReparÄƒ orice marcÄƒ'},{val:false,icon:'ðŸŽ¯',label:'UnimarcÄƒ',desc:'MÄƒrci specifice'}].map(opt=>(
                  ...
                  <div style={{marginBottom:20}}>
                    ...
                    <button onClick={()=>setPf(p=>({...p,is_dismantling:!p.is_dismantling}))}
                      ...
                      <div style={{width:48,height:48,background:pf.is_dismantling?'#fef3c7':'#f0f0f0',borderRadius:12,display:'flex',alignItems:'center',justifyContent:'center',fontSize:24,flexShrink:0}}>ðŸ”©</div>
                      <div style={{flex:1}}>
                        <div style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:14,color:pf.is_dismantling?'#d97706':S.navy,marginBottom:2}}>
                          {pf.is_dismantling ? 'âœ… Parc dezmembrÄƒri activ' : 'ActiveazÄƒ Parc dezmembrÄƒri'}
                        </div>
                        <div style={{fontSize:12,color:S.muted}}>PoÈ›i adÄƒuga piese dezmembrate È™i vehicule pentru dezmembrare</div>
                      </div>
                    ...
                    {pf.is_dismantling&&(
                      <div style={{marginTop:8,padding:'12px 14px',background:'#fef3c7',borderRadius:10,border:'1px solid #d9770620',fontSize:12,color:'#92400e'}}>
                        <div style={{marginBottom:8}}>ðŸ”© Ca parc dezmembrÄƒri, poÈ›i adÄƒuga piese È™i vehicule Ã®n secÈ›iunea <strong>AnunÈ›uri</strong>. Profilul tÄƒu va apÄƒrea Ã®n categoria DezmembrÄƒri.</div>
                        <a href="/dezmembrari-abonamente" target="_blank"
                          ...
                          ðŸ“¦ Vezi abonamente speciale pentru dezmembrÄƒri â†’
                        </a>
                      </div>
                    )}
                  </div>

                  {/* MÄƒrci acceptate â€” afiÈ™at Ã®ntotdeauna, cu buton Toate mai proeminent */}
                  <div style={{marginBottom:20}}>
                    <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:8}}>
                      <label style={label}>
                        {pf.is_multibrand ? 'MÄƒrci acceptate (toate implicit)' : 'MÄƒrci specializate *'}
                      </label>
                    ...
                    {pf.brands_accepted.length>0&&(
                      <div style={{fontSize:12,color:S.blue,marginTop:6,fontWeight:600}}>
                        {pf.brands_accepted.length} mÄƒrci selectate
                      </div>
                    )}
                  </div>
                  ...
                  <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:16}}>
                    ...
                    <div>
                      ...
                      <div style={{display:'flex',flexWrap:'wrap',gap:6}}>
                        {[['BenzinÄƒ','â›½'],['Diesel','ðŸ›¢ï¸'],['Hybrid','ðŸ”‹'],['Electric','âš¡'],['GPL','ðŸŸ¢']].map(([f,icon])=>(
                    ...
                    {/* Garantie + An minim */}
                    <div>
                      <label style={label}>GaranÈ›ie lucrÄƒri</label>
                      <select className="dash-input" value={pf.warranty_months} onChange={e=>setPf(p=>({...p,warranty_months:e.target.value}))} style={input}>
                        {['0','3','6','12','24','36'].map(m=><option key={m} value={m}>{m==='0'?'FÄƒrÄƒ garanÈ›ie':`${m} luni`}</option>)}
                      </select>
                    ...
                    {/* CertificÄƒri */}
                    <div>
                      <label style={label}>CertificÄƒri</label>
                      {[{k:'is_authorized_rar',l:'ðŸ›¡ï¸ Autorizat RAR'},{k:'has_itp',l:'âœ… ITP pe loc'}].map(opt=>(
              ...
              <div style={{display:'flex',justifyContent:'flex-end',marginTop:16}}>
                <button onClick={saveProfile} disabled={profileSaving}
                  ...
                  {profileSaved?'âœ… Profil salvat!':profileSaving?'Se salveazÄƒ...':'SalveazÄƒ toate modificÄƒrile â†’'}
                </button>
              </div>
            </div>
          )}

          {/* â•â• SERVICII OFERITE â•â• */}
          {tab==='Servicii oferite'&&(
            <div>
              ...
              <p style={{color:S.muted,fontSize:13,marginBottom:20}}>AdaugÄƒ serviciile cu preÈ›uri â€” clienÈ›ii le vÄƒd pe profilul tÄƒu.</p>

              <div style={card({marginBottom:16})}>
                <h3 style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:14,color:S.navy,marginBottom:14}}>+ AdaugÄƒ serviciu nou</h3>
                <div style={{display:'grid',gridTemplateColumns:'2fr 1fr 1fr 1fr',gap:12,marginBottom:12}}>
                  ...
                  <div>
                    <label style={label}>PreÈ› de la (RON)</label>
                  ...
                  <div>
                    <label style={label}>PreÈ› pÃ¢nÄƒ la (RON)</label>
                  ...
                  <div>
                    <label style={label}>DuratÄƒ (min)</label>
                ...
                <button onClick={addOffering} disabled={!newOffering.name} style={{...btn('primary'),opacity:!newOffering.name?.5:1}}>+ AdaugÄƒ serviciu</button>
              </div>

              {/* AdaugÄƒ rapid pe categorii */}
              <div style={card({marginBottom:16})}>
                <h3 style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:14,color:S.navy,marginBottom:4}}>âš¡ AdaugÄƒ rapid pe categorii</h3>
                <p style={{fontSize:12,color:S.muted,marginBottom:14}}>Click pe o categorie pentru a adÄƒuga toate serviciile din ea dintr-o datÄƒ.</p>
              ...
              {offerings.length===0?<div style={{...card(),textAlign:'center',padding:'40px 20px',color:S.muted}}>
                ...
                <div style={{fontWeight:600,fontSize:15,marginBottom:4}}>Niciun serviciu adÄƒugat</div>
                <div style={{fontSize:13}}>AdaugÄƒ serviciile pentru a apÄƒrea mai bine Ã®n cÄƒutÄƒri.</div>
              </div>:
                <div style={{display:'flex',flexDirection:'column',gap:8}}>
                  {offerings.map(o=>(
                    <div key={o.id} className="card-hover" style={{...card({padding:'14px 16px'}),display:'flex',alignItems:'center',gap:14}}>
                      <div style={{width:40,height:40,background:'#eaf3ff',borderRadius:10,display:'flex',alignItems:'center',justifyContent:'center',fontSize:18,flexShrink:0}}>ðŸ”§</div>
                      <div style={{flex:1}}>
                        ...
                        {o.duration_min&&<div style={{fontSize:12,color:S.muted}}>â±ï¸ ~{o.duration_min} min</div>}
                      </div>
                      <div style={{textAlign:'right',marginRight:12}}>
                        {(o.price_from||o.price_to)&&<div style={{fontFamily:"'Sora',sans-serif",fontWeight:800,fontSize:16,color:S.navy}}>{o.price_from&&o.price_to?`${o.price_from} â€“ ${o.price_to} RON`:o.price_from?`de la ${o.price_from} RON`:`pÃ¢nÄƒ la ${o.price_to} RON`}</div>}
                      </div>
                      <button onClick={()=>deleteOffering(o.id)} style={{background:'none',border:'none',cursor:'pointer',color:'#fca5a5',fontSize:18,padding:4}}>ðŸ—‘ï¸</button>
                    </div>
                  ))}
                </div>
              }
          ...
          {tab==='Cereri'&&(
            <div>
              <h1 style={{fontFamily:"'Sora',sans-serif",fontWeight:800,fontSize:18,color:S.navy,marginBottom:16}}>Cereri Ã®n {service?.city}</h1>
                ...
                <div onClick={e=>{if(e.target===e.currentTarget)setSelectedReq(null)}}
                  ...
                  <div style={{background:'#fff',borderRadius:'20px 20px 0 0',width:'100%',maxWidth:640,maxHeight:'90vh',overflowY:'auto',padding:20}}>
                    <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:16}}>
                      ...
                      <button onClick={()=>setSelectedReq(null)} style={{background:'none',border:'none',cursor:'pointer',fontSize:22,color:'#6b7280',lineHeight:1}}>âœ•</button>
                    </div>
                  <div style={card({marginBottom:12})}>
                    {/* Contact client */}
                    <div style={{background:'#eaf3ff',borderRadius:12,padding:'12px 16px',marginBottom:14,border:'1px solid rgba(26,86,219,0.15)'}}>
                      <div style={{fontSize:11,color:S.blue,fontWeight:700,textTransform:'uppercase',letterSpacing:0.5,marginBottom:10}}>ðŸ‘¤ Date contact client</div>
                      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
                        <div style={{display:'flex',alignItems:'center',gap:8}}>
                          ...
                          <div>
                            ...
                            <div style={{fontWeight:700,fontSize:14,color:S.navy}}>{selectedReq.contact_name||'â€”'}</div>
                          </div>
                        </div>
                        <div style={{display:'flex',alignItems:'center',gap:8}}>
                          ...
                          <div>
                            ...
                            ):<div style={{fontWeight:700,fontSize:14,color:S.muted}}>â€”</div>}
                          </div>
                        </div>
                        <div style={{display:'flex',alignItems:'center',gap:8}}>
                          <span style={{fontSize:18}}>ðŸ“</span>
                          <div>
                            <div style={{fontSize:10,color:S.muted,fontWeight:600,textTransform:'uppercase',letterSpacing:0.5}}>OraÈ™</div>
                            <div style={{fontWeight:700,fontSize:14,color:S.navy}}>{selectedReq.city||'â€”'}</div>
                          </div>
                        </div>
                        <div style={{display:'flex',alignItems:'center',gap:8}}>
                          <span style={{fontSize:18}}>ðŸ“…</span>
                    ...
                    <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:10,marginBottom:14}}>
                      {[['MaÈ™ina',`${selectedReq.car_brand} ${selectedReq.car_model} ${selectedReq.car_year||''}`],['Combustibil',selectedReq.car_fuel||'â€”'],['Kilometraj',selectedReq.car_km?`${Number(selectedReq.car_km).toLocaleString()} km`:'â€”'],['UrgenÈ›Äƒ',selectedReq.urgency||'â€”'],['Data preferatÄƒ',selectedReq.preferred_date||'â€”'],['Interval',selectedReq.preferred_time||'â€”']].map(([l,v])=>(
                    ...
                    {selectedReq.description&&<div style={{background:S.amberBg,borderRadius:10,padding:'10px 12px',border:`1px solid ${S.amber}30`}}>
                      <div style={{fontSize:10,color:S.amber,fontWeight:700,marginBottom:4}}>DESCRIERE PROBLEMÄ‚</div>
                      <p style={{fontSize:13,color:S.amber}}>{selectedReq.description}</p>
                    </div>}
                  </div>

                  <div style={card()}>
                    <h2 style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:15,color:S.navy,marginBottom:16}}>Trimite ofertÄƒ</h2>
                    {offerSent?<div style={{textAlign:'center',padding:'32px 0'}}>
                      <div style={{fontSize:48,marginBottom:12}}>âœ…</div>
                      <div style={{fontFamily:"'Sora',sans-serif",fontWeight:700,color:S.green,fontSize:16}}>Oferta a fost trimisÄƒ!</div>
                    </div>:(
                      <div>
                        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:10,marginBottom:12}}>
                          {[['price_total','PreÈ› total (RON)'],['price_parts','Piese (RON)'],['price_labor','ManoperÄƒ (RON)']].map(([k,l])=>(
                            <div key={k}>
                        ...
                        <div style={{marginBottom:12}}>
                          <label style={label}>Descriere ofertÄƒ</label>
                        ...
                        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:10,marginBottom:14}}>
                          <div>
                            <label style={label}>Data disponibilÄƒ</label>
                          ...
                          <div>
                            <label style={label}>GaranÈ›ie (luni)</label>
                        ...
                        <button onClick={sendOffer} style={{...btn('yellow'),width:'100%',justifyContent:'center',padding:'12px',fontSize:14}}>âœ‰ï¸ Trimite oferta</button>
                      </div>
                    )}
              ...
              {requests.length===0
                ?<div style={{...card(),textAlign:'center',padding:'40px 16px',color:S.muted}}>
                  ...
                  <div style={{fontWeight:600,marginBottom:4}}>Nicio cerere activÄƒ</div>
                  <div style={{fontSize:12}}>Vei fi notificat cÃ¢nd apar cereri noi.</div>
                </div>
                :<>{requests.map(r=>(
                  <button key={r.id} onClick={()=>setSelectedReq(r)} className="card-hover"
                    ...
                    <div style={{display:'flex',justifyContent:'space-between',marginBottom:8}}>
                      <div>
                        ...
                        <div style={{fontSize:12,color:S.muted,marginTop:2}}>{r.car_fuel}{r.car_km?` Â· ${r.car_km.toLocaleString()} km`:''}</div>
                      </div>
                    ...
                    <div style={{display:'flex',justifyContent:'space-between',alignItems:'center'}}>
                      ...
                      {r.contact_name&&<div style={{fontSize:12,fontWeight:600,color:S.blue}}>ðŸ‘¤ {r.contact_name}</div>}
                    </div>
                  </button>
                ))}</>
              }
          ...
          {tab==='ProgramÄƒri'&&(
            <div>
              <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:20,flexWrap:'wrap',gap:10}}>
                <h1 style={{fontFamily:"'Sora',sans-serif",fontWeight:800,fontSize:22,color:S.navy}}>Calendar programÄƒri</h1>
                <div style={{display:'flex',alignItems:'center',gap:10}}>
                  <span style={{fontSize:13,color:S.muted}}>{appointments.filter(a=>a.scheduled_date===today).length} programÄƒri azi</span>
                ...
                <div onClick={e=>{if(e.target===e.currentTarget)setShowAddApt(false)}}
                  ...
                  <div style={{background:'#fff',borderRadius:20,width:'100%',maxWidth:500,padding:28,maxHeight:'90vh',overflowY:'auto'}}>
                    <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:20}}>
                      <h3 style={{fontFamily:"'Sora',sans-serif",fontWeight:800,fontSize:17,color:S.navy}}>AdaugÄƒ programare</h3>
                      <button onClick={()=>setShowAddApt(false)} style={{background:'none',border:'none',cursor:'pointer',fontSize:20,color:S.muted}}>âœ•</button>
                    </div>
                    <div style={{display:'grid',gap:12}}>
                      ...
                      {/* Durata */}
                      <div>
                        <label style={label}>DuratÄƒ estimatÄƒ</label>
                        <select value={newApt.duration_min} onChange={e=>setNewApt(p=>({...p,duration_min:e.target.value}))} style={input}>
                          {[['30','30 minute'],['60','1 orÄƒ'],['90','1h 30min'],['120','2 ore'],['180','3 ore'],['240','4 ore'],['480','ToatÄƒ ziua']].map(([v,l])=>(
                      ...
                      {/* Masina */}
                      <div>
                        <label style={label}>MaÈ™ina</label>
                      ...
                      <div>
                        ...
                        <textarea value={newApt.work_description} onChange={e=>setNewApt(p=>({...p,work_description:e.target.value}))} rows={2}
                          placeholder="ex: Schimb ulei + filtre, FrÃ¢ne faÈ›Äƒ..." style={{...input,resize:'none'}}/>
                      </div>
                      {/* Note */}
                      <div>
                        <label style={label}>Note interne (opÈ›ional)</label>
                    ...
                    <button onClick={addManualAppointment} disabled={addingApt||!newApt.scheduled_date||!newApt.scheduled_time}
                      ...
                      {addingApt?'Se salveazÄƒ...':'âœ… SalveazÄƒ programarea'}
                    </button>
                  </div>
                </div>
              )}
              ...
              <div className="apt-layout" style={{display:'grid',gridTemplateColumns:'300px 1fr',gap:16}}>
                ...
                <div>
                  <div style={card({marginBottom:12})}>
                    <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:14}}>
                      <button onClick={()=>setCalMonth(d=>new Date(d.getFullYear(),d.getMonth()-1,1))} style={{background:S.bg,border:`1px solid ${S.border}`,borderRadius:8,width:30,height:30,cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center'}}>â€¹</button>
                      ...
                      <button onClick={()=>setCalMonth(d=>new Date(d.getFullYear(),d.getMonth()+1,1))} style={{background:S.bg,border:`1px solid ${S.border}`,borderRadius:8,width:30,height:30,cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center'}}>â€º</button>
                    </div>
                  ...
                  <div style={card()}>
                    ...
                    {[
                      ...
                      {label:'AceastÄƒ sÄƒptÄƒmÃ¢nÄƒ',count:appointments.filter(a=>{const d=new Date(a.scheduled_date);const now=new Date();const wk=new Date(now);wk.setDate(now.getDate()+7);return d>=now&&d<=wk}).length,color:S.green,bg:S.greenBg},
                      {label:'ÃŽn aÈ™teptare',count:appointments.filter(a=>(aptStatuses[a.id]||a.status)==='in_asteptare').length,color:S.amber,bg:S.amberBg},
                    ].map(r=>(
                ...
                <div style={{display:'flex',flexDirection:'column',gap:10}}>
                  {appointments.length===0
                    ?<div style={{...card(),textAlign:'center',padding:'60px 20px',color:S.muted}}>
                      ...
                      <div style={{fontSize:13}}>ProgramÄƒrile apar automat cÃ¢nd clienÈ›ii acceptÄƒ ofertele.</div>
                    </div>
                    :appointments.map(a=>{
                        ...
                        <div key={a.id} style={{...card({padding:16}),border:`1.5px solid ${isToday2?S.blue:S.border}`}}>
                          ...
                          <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:12}}>
                            <div>
                              ...
                              <div style={{display:'flex',alignItems:'center',gap:12,fontSize:13,color:S.muted}}>
                                <span>â° {a.scheduled_time||'OrÄƒ nespecificatÄƒ'}</span>
                                {a.duration_min&&<span>â±ï¸ ~{a.duration_min} min</span>}
                              </div>
                            </div>
                          ...
                          {(a.work_description||a.client_name||a.car_info)&&(
                            <div style={{background:S.bg,borderRadius:10,padding:'10px 12px',marginBottom:12}}>
                              {a.car_info&&<div style={{fontSize:12,color:S.navy,fontWeight:600,marginBottom:4}}>ðŸš— {a.car_info}</div>}
                              {a.client_name&&<div style={{fontSize:12,color:S.muted,marginBottom:4}}>ðŸ‘¤ {a.client_name}</div>}
                              {a.work_description&&<div style={{fontSize:13,color:S.text,lineHeight:1.5}}>{a.work_description}</div>}
                            </div>
                          )}

                          {/* Note */}
                          {a.notes&&<div style={{fontSize:13,color:S.muted,background:'#fffbf0',border:`1px solid ${S.amber}30`,borderRadius:8,padding:'8px 12px',marginBottom:12}}>ðŸ“ {a.notes}</div>}

                          {/* Butoane status */}
                          <div style={{display:'flex',gap:6,flexWrap:'wrap'}}>
                            {[
                              {s:'in_asteptare',l:'â³ AÈ™teptare'},
                              {s:'confirmata',l:'âœ… ConfirmatÄƒ'},
                              {s:'in_lucru',l:'ðŸ”§ ÃŽn lucru'},
                              {s:'finalizata',l:'ðŸ FinalizatÄƒ'},
                              {s:'anulata',l:'âŒ AnulatÄƒ'},
                            ].map(opt=>(
          ...
          {tab==='Oferte trimise'&&(
            <div>
              ...
              {offers.length===0?<div style={{...card(),textAlign:'center',padding:'60px 20px',color:S.muted}}>
                <div style={{fontSize:48,marginBottom:12}}>ðŸ’¬</div>
                <div style={{fontWeight:600,fontSize:15,marginBottom:8}}>Nicio ofertÄƒ trimisÄƒ</div>
                <button onClick={()=>setTab('Cereri')} style={btn('primary')}>Vezi cererile disponibile â†’</button>
              </div>:
                <div style={{display:'flex',flexDirection:'column',gap:8}}>
                  {offers.map(o=>(
                    <div key={o.id} style={{...card({padding:16})}}>
                        ...
                        <div style={{flex:1}}>
                          ...
                          <div style={{marginBottom:8}}>
                            <span style={{...pill(o.status==='acceptata'?S.greenBg:o.status==='refuzata'?S.redBg:o.status==='trimisa'?'#eaf3ff':S.bg,o.status==='acceptata'?S.green:o.status==='refuzata'?S.red:o.status==='trimisa'?S.blue:S.muted,''),fontSize:12,padding:'4px 12px'}}>
                              {o.status==='trimisa'?'ðŸ†• TrimisÄƒ â€” AÈ™teptÄƒm rÄƒspuns':o.status==='acceptata'?'âœ… AcceptatÄƒ de client':o.status==='refuzata'?'âŒ RefuzatÄƒ de client':'â° ExpiratÄƒ'}
                            </span>
                          </div>
                          {/* Pret */}
                          <div style={{fontFamily:"'Sora',sans-serif",fontWeight:800,fontSize:20,color:o.status==='acceptata'?S.green:S.navy,marginBottom:4}}>
                            {o.price_total?`${o.price_total.toLocaleString()} RON`:'PreÈ› negociabil'}
                          </div>
                          {/* Detalii pret */}
                          {(o.price_parts||o.price_labor)&&(
                            <div style={{fontSize:12,color:S.muted,marginBottom:4}}>
                              {o.price_parts&&`Piese: ${o.price_parts} RON`}{o.price_parts&&o.price_labor&&' Â· '}{o.price_labor&&`ManoperÄƒ: ${o.price_labor} RON`}
                            </div>
                          )}
                      ...
                      <div style={{display:'flex',gap:8,flexWrap:'wrap',paddingTop:10,borderTop:`1px solid ${S.border}`}}>
                        {o.available_date&&<span style={{fontSize:11,color:S.muted,background:S.bg,borderRadius:6,padding:'3px 8px'}}>ðŸ“… {new Date(o.available_date).toLocaleDateString('ro-RO')}</span>}
                        {o.available_time&&<span style={{fontSize:11,color:S.muted,background:S.bg,borderRadius:6,padding:'3px 8px'}}>â° {o.available_time}</span>}
                        {o.warranty_months>0&&<span style={{fontSize:11,color:S.muted,background:S.bg,borderRadius:6,padding:'3px 8px'}}>ðŸ›¡ï¸ GaranÈ›ie {o.warranty_months} luni</span>}
                        {o.status==='acceptata'&&(
                          <span style={{fontSize:11,color:S.green,fontWeight:700,marginLeft:'auto'}}>
                            ðŸŽ‰ Clientul a acceptat oferta ta!
                          </span>
                        )}
                      </div>
                    </div>
          ...
          {tab==='AnunÈ›uri'&&(
            <div>
              <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:20,flexWrap:'wrap',gap:10}}>
                <div>
                  <h1 style={{fontFamily:"'Sora',sans-serif",fontWeight:800,fontSize:22,color:S.navy,marginBottom:4}}>AnunÈ›urile mele</h1>
              ...
              <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(280px,1fr))',gap:14,marginBottom:20}}>
                ...
                <div style={card()}>
                  <div style={{display:'flex',alignItems:'center',gap:10,marginBottom:12}}>
                    <div style={{width:40,height:40,background:'#fef3c7',borderRadius:12,display:'flex',alignItems:'center',justifyContent:'center',fontSize:20}}>ðŸ”©</div>
                    <div>
                      <div style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:14,color:S.navy}}>Generator dezmembrÄƒri</div>
                      <div style={{fontSize:12,color:S.muted}}>GenereazÄƒ automat anunÈ›uri pentru toate piesele</div>
                    </div>
                  </div>
                  <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:8,marginBottom:10}}>
                    {[{k:'gen_brand',l:'MarcÄƒ',p:'ex: BMW'},{k:'gen_model',l:'Model',p:'ex: Seria 5'},{k:'gen_year',l:'An',p:'2015'},{k:'gen_vin',l:'VIN (opÈ›.)',p:'17 caractere'}].map(f=>(
                      <div key={f.k}>
                        <label style={label}>{f.l}</label>
                  ...
                  <button onClick={async()=>{
                    if(!pf.gen_brand||!pf.gen_model){alert('CompleteazÄƒ marca È™i modelul!');return}
                    if(!service||!user) return
                    const piese=[
                      'Motor complet','Cutie viteze manualÄƒ','Alternator','Electromotor',
                      'Compresor AC','Radiator apÄƒ','Radiator AC','PompÄƒ apÄƒ','TurbinÄƒ',
                      'Injectoare set','PompÄƒ injecÈ›ie','Calculator motor',
                      'UÈ™Äƒ faÈ›Äƒ stÃ¢nga','UÈ™Äƒ faÈ›Äƒ dreapta','UÈ™Äƒ spate stÃ¢nga','UÈ™Äƒ spate dreapta',
                      'CapotÄƒ faÈ›Äƒ','Portbagaj','BarÄƒ faÈ›Äƒ','BarÄƒ spate',
                      'AripÄƒ faÈ›Äƒ stÃ¢nga','AripÄƒ faÈ›Äƒ dreapta',
                      'Far faÈ›Äƒ stÃ¢nga','Far faÈ›Äƒ dreapta','Stop spate stÃ¢nga','Stop spate dreapta',
                      'PlanetarÄƒ stÃ¢nga','PlanetarÄƒ dreapta','Amortizor faÈ›Äƒ stÃ¢nga','Amortizor faÈ›Äƒ dreapta',
                      'FuzetÄƒ faÈ›Äƒ stÃ¢nga','FuzetÄƒ faÈ›Äƒ dreapta',
                      'Volan','Airbag volan','Airbag pasager','Centuri siguranÈ›Äƒ set',
                      'Bloc instrumente bord','Radio original','Geam faÈ›Äƒ','Geam spate',
                    ]
                    const inserts=piese.map(p=>({
                      user_id:user.id,
                      title:`${p} ${pf.gen_brand} ${pf.gen_model}${pf.gen_year?' '+pf.gen_year:''}`,
                      description:`${p} demontat de pe ${pf.gen_brand} ${pf.gen_model}${pf.gen_year?' ('+pf.gen_year+')':''}${pf.gen_vin?' Â· VIN: '+pf.gen_vin:''}. PiesÄƒ originalÄƒ testatÄƒ, Ã®n stare bunÄƒ de funcÈ›ionare.`,
                      category:'piese',condition:'folosit',
                      city:service.city||'BucureÈ™ti',
                      status:'activ',
                    }))
                    const{error}=await supabase.from('listings').insert(inserts)
                    if(error){alert('Eroare: '+error.message);return}
                    alert(`âœ… ${piese.length} anunÈ›uri generate! EditeazÄƒ preÈ›urile din "GestioneazÄƒ anunÈ›uri".`)
                    ...
                    âš¡ GenereazÄƒ 40 anunÈ›uri automat
                  </button>
                </div>
                ...
                <div style={card()}>
                  <div style={{display:'flex',alignItems:'center',gap:10,marginBottom:12}}>
                    <div style={{width:40,height:40,background:'#eaf3ff',borderRadius:12,display:'flex',alignItems:'center',justifyContent:'center',fontSize:20}}>ðŸ“Š</div>
                    <div>
                      <div style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:14,color:S.navy}}>Import CSV / XML</div>
                      <div style={{fontSize:12,color:S.muted}}>ImportÄƒ stocul din fiÈ™ier direct pe platformÄƒ</div>
                    </div>
                  </div>
                  <div style={{background:S.bg,borderRadius:10,padding:'10px 12px',marginBottom:10,fontSize:11,color:S.muted,lineHeight:1.7}}>
                    ...
                    <div style={{marginTop:4}}>Prima linie = antet. CÃ¢mpurile opÈ›ionale pot fi goale.</div>
                  </div>
                ...
                <div style={card()}>
                  <div style={{display:'flex',alignItems:'center',gap:10,marginBottom:12}}>
                    <div style={{width:40,height:40,background:'#dcfce7',borderRadius:12,display:'flex',alignItems:'center',justifyContent:'center',fontSize:20}}>ðŸ”„</div>
                    <div>
                      <div style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:14,color:S.navy}}>Relistare automatÄƒ</div>
                      <div style={{fontSize:12,color:S.muted}}>AnunÈ›urile urcÄƒ automat Ã®n top</div>
                    </div>
                  </div>
                  <div style={{marginBottom:12}}>
                    {[
                      ...
                      <div key={p.plan} style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'8px 12px',borderRadius:8,background:p.active?'#dcfce7':S.bg,marginBottom:6,border:`1px solid ${p.active?S.green:S.border}`}}>
                        ...
                        {p.active?<span style={{fontSize:11,fontWeight:700,color:S.green}}>âœ… Activ</span>
              ...
              <a href="/anunturile-mele"
                ...
                <div style={{width:52,height:52,background:'#eaf3ff',borderRadius:14,display:'flex',alignItems:'center',justifyContent:'center',fontSize:26}}>ðŸ“‹</div>
                <div style={{flex:1}}>
                  <div style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:15,color:S.navy,marginBottom:4}}>GestioneazÄƒ toate anunÈ›urile</div>
                  <div style={{fontSize:13,color:S.muted}}>EditeazÄƒ preÈ›uri, activeazÄƒ/dezactiveazÄƒ, È™terge.</div>
                </div>
                <div style={{color:S.blue,fontSize:20,fontWeight:300}}>â†’</div>
              </a>
            </div>
          )}
            ...
            <div>
              <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:20,flexWrap:'wrap',gap:10}}>
                ...
                {service?.rating_count>0&&<div style={{display:'flex',alignItems:'center',gap:8,background:S.amberBg,border:`1px solid ${S.amber}30`,padding:'8px 16px',borderRadius:50}}>
                  ...
                  <div><div style={{display:'flex',gap:1}}>{[1,2,3,4,5].map(s=><span key={s} style={{fontSize:12,color:s<=Math.round(service.rating_avg)?S.yellow:'#ddd'}}>â˜…</span>)}</div><div style={{fontSize:10,color:S.muted}}>{service.rating_count} recenzii</div></div>
                </div>}
              </div>
              ...
              {reviews.length>0&&(
                <div style={{...card({marginBottom:16})}}>
                  <div style={{fontSize:12,fontWeight:700,color:S.muted,textTransform:'uppercase',letterSpacing:0.5,marginBottom:10}}>DistribuÈ›ie rating</div>
                  {[5,4,3,2,1].map(star=>{
                    ...
                    return (
                      <div key={star} style={{display:'flex',alignItems:'center',gap:8,marginBottom:6}}>
                        ...
                        <span style={{color:S.yellow,fontSize:12}}>â˜…</span>
              ...
              {reviews.length===0
                ?<div style={{...card(),textAlign:'center',padding:'60px 20px',color:S.muted}}><div style={{fontSize:48,marginBottom:10}}>â­</div>Nicio recenzie Ã®ncÄƒ.</div>
                :reviews.map(r=>(
                  <div key={r.id} style={{...card({marginBottom:10})}}>
                    <div style={{display:'flex',alignItems:'flex-start',justifyContent:'space-between',marginBottom:10}}>
                      <div>
                        <div style={{display:'flex',gap:2,marginBottom:4}}>{[1,2,3,4,5].map(s=><span key={s} style={{fontSize:16,color:s<=r.rating?S.yellow:'#e5e7eb'}}>â˜…</span>)}</div>
                        <div style={{fontSize:12,color:S.muted}}>{r.client_name||'Client anonim'} Â· {new Date(r.created_at).toLocaleDateString('ro-RO')}</div>
                      </div>
                      <div style={{display:'flex',gap:6}}>
                        {!r.reply_text&&<button onClick={()=>setReplyingTo(r.id)} style={{...btn('ghost'),fontSize:11,padding:'5px 10px'}}>ðŸ’¬ RÄƒspunde</button>}
                        <button onClick={async()=>{
                          if(!confirm('Raportezi aceastÄƒ recenzie ca falsÄƒ?')) return
                          ...
                          alert('Recenzia a fost raportatÄƒ. O vom analiza Ã®n 24h.')
                          ...
                          {r.is_reported?'âš ï¸ Raportat':'ðŸš¨ RaporteazÄƒ'}
                        </button>
                      </div>
                    </div>
                    ...
                    {r.reply_text
                      ?<div style={{background:'#eaf3ff',borderRadius:10,padding:'10px 12px',border:`1px solid ${S.blue}20`}}>
                        <div style={{fontSize:10,fontWeight:700,color:S.blue,marginBottom:4}}>RÄ‚SPUNSUL TÄ‚U</div>
                        <p style={{fontSize:13,color:S.blue,margin:0}}>{r.reply_text}</p>
                        <button onClick={()=>{setReplyingTo(r.id);setReplyText(r.reply_text)}} style={{fontSize:11,color:S.blue,background:'none',border:'none',cursor:'pointer',marginTop:6,padding:0}}>âœï¸ EditeazÄƒ</button>
                      </div>
                      :replyingTo===r.id?(
                        <div>
                          <textarea value={replyText} onChange={e=>setReplyText(e.target.value)} rows={3}
                            placeholder="RÄƒspunsul tÄƒu public la aceastÄƒ recenzie..."
                            style={{...input,resize:'none',marginBottom:8}}/>
                          <div style={{display:'flex',gap:8}}>
                            <button onClick={()=>sendReply(r.id)} style={btn('primary')}>PublicÄƒ rÄƒspunsul</button>
                            <button onClick={()=>{setReplyingTo(null);setReplyText('')}} style={btn('ghost')}>AnuleazÄƒ</button>
                          </div>
                        </div>
                      ):null
                    }
          ...
          {tab==='SetÄƒri'&&(
            <div>
              <h1 style={{fontFamily:"'Sora',sans-serif",fontWeight:800,fontSize:22,color:S.navy,marginBottom:6}}>SetÄƒri cont</h1>
              <p style={{fontSize:14,color:S.muted,marginBottom:24}}>GestioneazÄƒ abonamentul, notificÄƒrile È™i securitatea contului tÄƒu.</p>
              ...
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:16,marginBottom:16}}>
                ...
                <div style={{...card(),gridColumn:'1/-1'}}>
                  <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:16}}>
                    <h3 style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:15,color:S.navy}}>ðŸ’³ Plan abonament</h3>
                    {service?.plan_expires_at&&<div style={{fontSize:12,color:S.muted}}>ExpirÄƒ: {new Date(service.plan_expires_at).toLocaleDateString('ro-RO')}</div>}
                  </div>
                  <div className="settings-plans" style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:12}}>
                    {[
                      {plan:'free',label:'Free',price:'0',period:'',color:S.muted,features:['Profil public basic','Cereri limitate','NotificÄƒri in-app','FÄƒrÄƒ badge verificat','Statistici de bazÄƒ']},
                      {plan:'basic',label:'Basic',price:'99',period:'/lunÄƒ',color:S.blue,features:['Cereri nelimitate','NotificÄƒri instant + email','Badge âœ“ Verificat','Statistici avansate','Prioritate medie Ã®n cÄƒutÄƒri','Suport prin email']},
                      {plan:'pro',label:'Pro',price:'199',period:'/lunÄƒ',color:S.amber,features:['Tot din Basic','Prioritate maximÄƒ Ã®n cÄƒutÄƒri','Badge Pro â­','Promovare inclusÄƒ 7 zile/lunÄƒ','Statistici complete','Suport dedicat prioritar','API integrare externe']},
                    ].map(p=>(
                      <div key={p.plan} style={{borderRadius:14,padding:16,border:`2px solid ${service?.plan===p.plan?p.color:S.border}`,background:service?.plan===p.plan?p.plan==='pro'?S.amberBg:p.plan==='basic'?'#eaf3ff':S.bg:S.white,position:'relative',transition:'all .2s'}}>
                        ...
                        {p.features.map(f=>(
                          <div key={f} style={{display:'flex',alignItems:'center',gap:6,marginBottom:5,fontSize:12,color:S.muted}}>
                            <span style={{color:p.color,fontWeight:700}}>âœ“</span>{f}
                          </div>
                        ))}
                        {service?.plan!==p.plan&&p.plan!=='free'&&(
                          <button
                            onClick={async()=>{
                              ...
                              if(url) window.location.href=url
                              else alert(error||'Stripe nu este configurat Ã®ncÄƒ. AdaugÄƒ STRIPE_SECRET_KEY Ã®n Vercel.')
                            }}
                            ...
                            Upgrade la {p.label} â†’
                          </button>
                        )}
                        {service?.plan===p.plan&&p.plan==='free'&&(
                          <div style={{marginTop:12,fontSize:11,color:S.muted,textAlign:'center',lineHeight:1.5}}>Upgrade pentru mai multe funcÈ›ii</div>
                        )}
                        {service?.plan===p.plan&&p.plan!=='free'&&(
                          <div style={{marginTop:12,fontSize:12,color:p.color,fontWeight:600,textAlign:'center'}}>âœ… Planul tÄƒu curent</div>
                        )}
                      </div>
                    ))}
                  </div>
                ...
                {/* Banner Dezmembrari â€” mereu vizibil */}
                <div style={{...card(),background:'#fef3c7',border:'1px solid rgba(217,119,6,0.2)',display:'flex',alignItems:'center',justifyContent:'space-between',gap:12,flexWrap:'wrap'}}>
                  <div style={{display:'flex',alignItems:'center',gap:12}}>
                    ...
                    <div>
                      <div style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:13,color:'#92400e',marginBottom:2}}>EÈ™ti parc de dezmembrÄƒri?</div>
                      <div style={{fontSize:12,color:'#b45309',lineHeight:1.5}}>Avem abonamente speciale cu funcÈ›ii dedicate: generator piese, relistare automatÄƒ, ofertare nelimitatÄƒ.</div>
                    </div>
                  </div>
                  <a href="/dezmembrari-abonamente" target="_blank"
                ...
                {/* Promovare */}
                <div style={card()}>
                  <h3 style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:15,color:S.navy,marginBottom:12}}>ðŸš€ Promovare service</h3>
                  <p style={{fontSize:13,color:S.muted,marginBottom:14,lineHeight:1.6}}>Apari primul Ã®n cÄƒutÄƒri din oraÈ™ul tÄƒu. Vizibilitate maximÄƒ, mai mulÈ›i clienÈ›i.</p>
                  {service?.is_promoted&&service?.promoted_until?(
                    <div style={{background:S.amberBg,borderRadius:10,padding:'10px 14px',marginBottom:12,border:`1px solid ${S.amber}30`}}>
                      <div style={{fontWeight:700,fontSize:13,color:S.amber}}>â­ Promovare activÄƒ</div>
                      <div style={{fontSize:12,color:S.amber,opacity:.8}}>PÃ¢nÄƒ pe {new Date(service.promoted_until).toLocaleDateString('ro-RO')}</div>
                    </div>
                  ):(
                  ...
                  <div style={{fontSize:11,color:S.muted}}>ðŸ’¡ Serviciile promovate primesc Ã®n medie 3x mai multe cereri.</div>
                </div>

                {/* NotificÄƒri */}
                <div style={card()}>
                  <h3 style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:15,color:S.navy,marginBottom:14}}>ðŸ”” NotificÄƒri</h3>
                  {[
                    {label:'Cerere ofertÄƒ nouÄƒ',desc:'CÃ¢nd un client trimite o cerere Ã®n oraÈ™ul tÄƒu',key:'notif_requests',default:true},
                    {label:'Programare confirmatÄƒ',desc:'CÃ¢nd un client acceptÄƒ oferta ta',key:'notif_appointments',default:true},
                    {label:'Recenzie nouÄƒ',desc:'CÃ¢nd primeÈ™ti o recenzie de la un client',key:'notif_reviews',default:true},
                    {label:'Mesaj nou',desc:'CÃ¢nd primeÈ™ti un mesaj de la un client',key:'notif_messages',default:true},
                  ].map((n,i)=>(
                ...
                {/* Securitate */}
                <div style={card()}>
                  <h3 style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:15,color:S.navy,marginBottom:14}}>ðŸ”’ Securitate cont</h3>
                  <div style={{display:'flex',flexDirection:'column',gap:10}}>
                    <a href="/auth/forgot-password" style={{display:'flex',alignItems:'center',gap:12,padding:'12px 14px',background:S.bg,borderRadius:12,textDecoration:'none',border:`1px solid ${S.border}`,transition:'border-color .15s'}}
                      onMouseEnter={e=>e.currentTarget.style.borderColor=S.blue}
                      onMouseLeave={e=>e.currentTarget.style.borderColor=S.border}>
                      <div style={{width:36,height:36,background:'#eaf3ff',borderRadius:10,display:'flex',alignItems:'center',justifyContent:'center',fontSize:16}}>ðŸ”‘</div>
                      <div>
                        <div style={{fontSize:13,fontWeight:600,color:S.navy}}>SchimbÄƒ parola</div>
                        <div style={{fontSize:11,color:S.muted}}>Trimite email de resetare</div>
                      </div>
                      <span style={{marginLeft:'auto',color:S.blue,fontSize:14}}>â†’</span>
                    </a>
                    <a href="/messages" style={{display:'flex',alignItems:'center',gap:12,padding:'12px 14px',background:S.bg,borderRadius:12,textDecoration:'none',border:`1px solid ${S.border}`,transition:'border-color .15s'}}
                      ...
                      <div style={{width:36,height:36,background:'#eaf3ff',borderRadius:10,display:'flex',alignItems:'center',justifyContent:'center',fontSize:16}}>ðŸ’¬</div>
                      <div>
                        <div style={{fontSize:13,fontWeight:600,color:S.navy}}>Mesaje clienÈ›i</div>
                    ...
                    {service?.id&&(
                      <a href={`/service/${service.id}`} target="_blank" style={{display:'flex',alignItems:'center',gap:12,padding:'12px 14px',background:S.bg,borderRadius:12,textDecoration:'none',border:`1px solid ${S.border}`,transition:'border-color .15s'}}
                        onMouseEnter={e=>e.currentTarget.style.borderColor=S.blue}
                        onMouseLeave={e=>e.currentTarget.style.borderColor=S.border}>
                        <div style={{width:36,height:36,background:'#eaf3ff',borderRadius:10,display:'flex',alignItems:'center',justifyContent:'center',fontSize:16}}>ðŸ‘ï¸</div>
                        <div>
                          <div style={{fontSize:13,fontWeight:600,color:S.navy}}>Profilul public</div>
                          <div style={{fontSize:11,color:S.muted}}>Cum te vÄƒd clienÈ›ii</div>
                        </div>
                        <span style={{marginLeft:'auto',color:S.blue,fontSize:14}}>â†—</span>
                      </a>
                    )}
                ...
                <div style={{background:S.redBg,border:`1px solid ${S.red}20`,borderRadius:16,padding:20,gridColumn:'1/-1'}}>
                  <h3 style={{fontFamily:"'Sora',sans-serif",fontWeight:700,fontSize:15,color:S.red,marginBottom:6}}>âš ï¸ Zona periculoasÄƒ</h3>
                  <p style={{fontSize:13,color:S.red,opacity:.8,marginBottom:14,lineHeight:1.6}}>Aceste acÈ›iuni sunt ireversibile sau pot afecta vizibilitatea profilului tÄƒu.</p>
                  <div style={{display:'flex',gap:10,flexWrap:'wrap'}}>
                    <button onClick={async()=>{
                        if(!confirm('EÈ™ti sigur cÄƒ vrei sÄƒ dezactivezi profilul? ClienÈ›ii nu te vor mai putea gÄƒsi Ã®n cÄƒutÄƒri.')) return
                      ...
                      {service?.is_active?'DezactiveazÄƒ profilul temporar':'ReactiveazÄƒ profilul'}
                    </button>
                    <button onClick={async()=>{
