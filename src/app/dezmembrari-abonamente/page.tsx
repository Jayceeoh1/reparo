...
const CHECK = () => (
  ...
  >
    ...
    <polyline
      points="4.5,8 6.8,10.5 11.5,5.5"
      fill="none"
      stroke="#16a34a"
      strokeWidth="1.8"
      strokeLinecap="round"
  ...
  business: [
    ...
    },
    {
      ...
      features: [
        ...
        { label: "Afișare prioritară în catalog firme", value: false },
        {
          label: "Anunțuri consecutive în căutări",
          value: "2 anunțuri relevante",
        },
        { label: "Ofertare la cereri piese", value: "Nelimitat" },
    ...
    },
    {
      ...
      features: [
        {
          label: "Afișare prioritară în căutări",
          value: "1 anunț relevant / căutare",
        },
...
function FeatureRow({ label, value }) {
  ...
  return (
    <div style={{ padding: "10px 0", borderBottom: `1px solid ${S.border}` }}>
      <div style={{ fontSize: 12, color: S.muted, marginBottom: 3 }}>
        {label}
      </div>
      <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
        ...
        <span
          style={{
            fontSize: 13,
            fontWeight: 600,
            color: isTrue ? S.green : isFalse ? "#9ca3af" : S.navy,
          }}
        >
  ...
  return (
    <>
      ...
      >
        ...
        <div
          style={{
            background: `linear-gradient(135deg,${S.navy} 0%,#1a3a6b 100%)`,
        ...
        >
          ...
          >
            Publică piese și vehicule pentru dezmembrare. Primești cereri de
            ofertă direct de la clienți din toată România.
          </p>
            ...
            {(["basic", "business"] as const).map((t) => (
              <button
                ...
                style={{
                  ...
                  color: tab === t ? S.navy : "rgba(255,255,255,0.7)",
                  transition: "all .2s",
                }}
              >
          ...
          {tab === "business" && (
            ...
            >
              ⓘ Aceste abonamente sunt pentru persoane juridice
            </p>
          )}
        </div>
        ...
        <div style={{ maxWidth: 960, margin: "0 auto", padding: "32px 16px" }}>
            ...
            {plans.map((plan) => (
              <div
                ...
                style={{
                  background: S.white,
                  borderRadius: 20,
                  border: `2px solid ${plan.popular ? plan.accent : S.border}`,
                  overflow: "hidden",
                  position: "relative",
                }}
              >
                ...
                <div
                  style={{
                    padding: plan.popular ? "44px 24px 20px" : "24px 24px 20px",
                    ...
                    {plan.badge && (
                      <div
                        style={{
                          ...
                          color: "#fff",
                          fontSize: plan.badge.length > 1 ? 11 : 18,
                          fontWeight: 800,
                          flexShrink: 0,
                        }}
                      >
          ...
          >
            ...
            >
              {[
                {
                  icon: "🔄",
                  title: "Relistare automată",
                  desc: "Anunțurile tale urcă automat în top la intervalul ales, fără intervenție manuală.",
                },
                {
                  icon: "📦",
                  title: "Generator dezmembrări",
                  desc: "Adaugă o mașină și generăm automat anunțuri pentru toate piesele disponibile.",
                },
                {
                  icon: "📩",
                  title: "Cereri de ofertă",
                  desc: "Primești direct cereri de la clienți care caută piese pentru mașina lor.",
                },
                {
                  icon: "📊",
                  title: "Import CSV/XML",
                  desc: "Importă stocul din sistemul tău existent direct pe platformă în câteva clicuri.",
                },
              ].map((item) => (
                <div
                  key={item.title}
                ...
                >
                  ...
                  <div>
                    ...
                    <div
                      style={{ fontSize: 12, color: S.muted, lineHeight: 1.6 }}
                    >
                      {item.desc}
                    </div>
                  </div>
          ...
          >
            Prețurile sunt exprimate în RON + TVA · Facturare lunară · Poți
            anula oricând
          </p>
        </div>
      </div>
        ...
        >
          <div
            style={{
              ...
              maxWidth: 420,
              width: "100%",
              boxShadow: "0 20px 60px rgba(10,31,68,0.2)",
            }}
              ...
              <>
                ...
                >
                  <div>
                    ...
                    >
                      Activează {modal.name}
                    </div>
                    <div style={{ fontSize: 13, color: "#6b7280" }}>
                      Abonament lunar · Anulezi oricând
                    </div>
                  </div>
                  <button
                    onClick={() => setModal(null)}
                ...
                >
                  ...
                  <div style={{ fontSize: 12, color: "#6b7280" }}>
                    + TVA · Facturare automată lunar · Anulezi oricând
                  </div>
                </div>
                ...
                >
                  Plată securizată prin Stripe · SSL encrypted
                </p>
              </>
            )}
          </div>
